...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ["@earendil-works/pi-ai", "ws"],
  ...
  // build can silently omit e.g. openai-completions.js. Force the whole pi-ai
  // dist into the standalone output so the provider set is always complete.
  outputFileTracingIncludes: {
    "/api/**": ["./node_modules/@earendil-works/pi-ai/dist/**/*.js"],
  },
